...
const checkAccess = (feature, subscriptionTier) => {
...
const getPlanLimits = (subscriptionTier) => {
  const tierLower = (subscriptionTier || 'starter').toLowerCase();
...
const getPlanBadge = (subscriptionTier) => {
  const tierLower = (subscriptionTier || 'starter').toLowerCase();
...
const Card = ({ title, icon, children, className = '', locked = false, onUnlock, action }) => (
...
const CommercialDashboard = () => {
  ...
  const planBadge = getPlanBadge(subscriptionTier);
